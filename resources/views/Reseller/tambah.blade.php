            ...
            <div class="card-body" style="margin-top: 40px">
                <div class="row gutters">
                    ...
                    <div class="row  ml-2">
                        ...
                        <div class="col-md-4 "><label for="fullName" class='font-weight-bold'>ID Reseller</label></div>
                        ...
                        <div class="col-md-12 row">
                        <div class="col-md-4 mb-2"><input type="text" class="form-control" id="fullName" name="reseller_id" value="{{$reseller_id[0]->ID}}"
                                    readonly></div>
